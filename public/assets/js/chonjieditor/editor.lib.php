<?php
if (!defined('_GNUBOARD_')) exit; // 개별 페지 접근 불가
...
function editor_html($id, $content, $is_dhtml_editor=true)
{
    ...
    $html = "";
    $html .= "<span class=\"sound_only\">웨브편집기 시작</span>";
    if ($is_dhtml_editor)
        $html .= '<script>document.write("<div class=\'cke_sc\'><button type=\'button\' class=\'btn_cke_sc\'>단축건 일람</button></div>");</script>';
    ...
    $html .= "\n<span class=\"sound_only\">웨브 편집기 끝</span>";
    return $html;
}
